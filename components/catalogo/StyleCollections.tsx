...
const collections = [
  { title: "Delicados", text: "Pecas leves para acompanhar todos os dias.", image: fallbackImages[0] },
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16">
      <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.26em] text-[#C9A227]">Colecao editorial</p>
