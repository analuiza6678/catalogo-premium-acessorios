  ...
  return (
    <AnimatedReveal className="mx-auto max-w-7xl px-4 py-16">
      <div className="mb-8 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.26em] text-[#C9A227]">Pecas mais desejadas</p>
          <h2 className="mt-3 font-serif text-5xl text-[#1E1A18]">Destaques da Colecao</h2>
        </div>
        <p className="max-w-md text-sm leading-7 text-[#76675f]">Uma vitrine com pecas que carregam brilho, delicadeza e presenca sem exagero.</p>
      </div>
