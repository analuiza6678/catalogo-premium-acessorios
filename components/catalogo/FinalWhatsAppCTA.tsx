  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#F8DDEB,#FAF3E8_45%,#E8C766_150%)] px-4 py-24">
      ...
      <div className="relative mx-auto max-w-5xl rounded-[48px] border border-white/75 bg-white/62 p-8 text-center shadow-[0_32px_110px_rgba(58,42,36,0.13)] backdrop-blur-xl sm:p-10">
        ...
        <h2 className="mt-3 font-serif text-5xl leading-tight text-[#1E1A18]">Gostou de alguma peca?</h2>
        <p className="mx-auto mt-4 max-w-2xl text-sm leading-8 text-[#665b55]">Monte seu pedido no carrinho ou fale diretamente com a loja pelo WhatsApp.</p>
        <div className="mx-auto mt-7 grid max-w-3xl gap-3 sm:grid-cols-3">
          {["Escolha os produtos", "Adicione ao carrinho", "Finalize no WhatsApp"].map((step, index) => (
