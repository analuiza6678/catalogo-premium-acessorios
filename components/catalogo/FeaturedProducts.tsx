  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14">
      <div className="mb-7 max-w-2xl">
        <h2 className="font-serif text-4xl text-preto sm:text-5xl">Destaques da Coleção</h2>
        <p className="mt-3 leading-7 text-texto">Peças escolhidas para deixar seu estilo ainda mais delicado.</p>
      </div>
      {produtos.length ? (
        ...
        <PremiumEmptyState whatsapp={whatsapp} title="Destaques em breve" text="A coleção ainda está sendo preparada, mas você já pode falar com a loja para receber novidades." />
      )}
    </section>
  );
}
