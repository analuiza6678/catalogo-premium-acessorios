...
using (exists (select 1 from public.lojas where lojas.id = store_theme.loja_id and lojas.ativa = true));
...
for all
to authenticated
using (exists (select 1 from public.lojas where lojas.id = store_theme.loja_id and lojas.user_id = (select auth.uid())))
with check (exists (select 1 from public.lojas where lojas.id = store_theme.loja_id and lojas.user_id = (select auth.uid())));
...
for select
to anon, authenticated
using (enabled = true and exists (select 1 from public.lojas where lojas.id = store_sections.loja_id and lojas.ativa = true));
...
for all
to authenticated
using (exists (select 1 from public.lojas where lojas.id = store_sections.loja_id and lojas.user_id = (select auth.uid())))
with check (exists (select 1 from public.lojas where lojas.id = store_sections.loja_id and lojas.user_id = (select auth.uid())));
...
for all
to authenticated
using (exists (select 1 from public.lojas where lojas.id = store_revisions.loja_id and lojas.user_id = (select auth.uid())))
with check (exists (select 1 from public.lojas where lojas.id = store_revisions.loja_id and lojas.user_id = (select auth.uid())));
